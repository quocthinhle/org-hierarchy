...
import { TreeNode } from './lqt12-hierarchy.type';
import { PrimeTemplate } from 'primeng/api';
import { Subject, Subscription } from 'rxjs';

@Component({
  selector: '[lqt12Hierarchy]',
  template: `
        <tbody *ngIf="node">
            <tr>
    ...
    `,
  animations: [
    trigger('childState', [state('in', style({ opacity: 1 })),
...
export class Lqt12HierarchyComponent implements OnDestroy {
  @Input() node!: TreeNode;
